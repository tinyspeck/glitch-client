package com.tinyspeck.engine.view.ui
{
	...
	public class ChassisToolbarUI extends Sprite implements IRefreshListener
	{
		...
		public function ChassisToolbarUI(){			
			//tfs
			TFUtil.prepTF(title_tf, false);
			title_tf.htmlText = '<p class="decorate_toolbar">You are in House Changing Mode</p>';
		...
		public function setText(txt:String):void {
			title_tf.htmlText = '<p class="decorate_toolbar">'+txt+'</p>';
		}
		...
		public function refresh():void {
			//move the close button where it needs to go
		...
		private function onCloseClick(event:TSEvent):void {
			...
			ChassisManager.instance.closeFromUserInput();
		}
