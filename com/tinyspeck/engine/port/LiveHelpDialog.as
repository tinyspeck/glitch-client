package com.tinyspeck.engine.port
{
	...
	public class LiveHelpDialog extends BigDialog
	{
		...
		private function buildBase():void {
			...
			ok_bt = new Button({
				name: 'ok',
				label: 'OK! I will only use this for help!',
		...
		override public function start():void {
			...
			_setTitle('Hey! It\'s the Help Channel!');
		...
		private function getBodyText():String {
			return '<p class="live_help_body">This chat channel exists for players to ask and answer questions about the game.<br><br>'+
				   'Please use the global chat channel for anything else and keep this free for helping. Thanks!</p>';
		}
		
		private function onOkClick(event:TSEvent):void {
			//if they are hitting ok, close it up and join the channel
			end(true);
			//RightSideManager.instance.chatStart(ChatArea.NAME_HELP, true, true);
			RightSideManager.instance.groupStart(ChatArea.NAME_HELP, true);
		}
	}
}