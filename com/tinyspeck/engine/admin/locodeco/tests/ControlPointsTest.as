...
public class ControlPointsTest extends Sprite
{
	private var transformer:MultiControlPoints;
	private var transformer2:MultiControlPoints;
	
	public function ControlPointsTest()
	{
		...
		const objCP2:AbstractControlPoints = new MoveableControlPoints();
		objCP2.stage = stage;
		...
		transformer2 = new MultiControlPoints();
		transformer2.stage = stage;
		transformer2.registerControlPoint(obj2, objCP2);
		addChild(transformer2);
	}
}
}